#
# Be sure to run `pod lib lint ZKUIKit.podspec' to ensure this is a
...
a video player from zhike project
  ...
  s.source           = { :git => 'https://github.com/bestofsong/ZKUIKit.git', :tag => s.version.to_s }
  ...
  s.resource_bundles = {
    'ZKUIKit-Images' => ['ZKUIKit/Assets/*.png']
  }
